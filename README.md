...
The core was verified using Icarus Verilog and GTKWave. The test program (program.hex) executes an iterative loop computing the summation of integers from 1 to 5 (sum = 15) and stores the final result into data memory address 0:
